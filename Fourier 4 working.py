...
class OutputScreen(Screen):
    ...
    def generate_input_boxes(self, number1, number2):
        ...
        for i in range(number1):
            label1 = Label(text=f'TInput {i + 1}')
            ...
            # self.inputs_layout1.add_widget(label1)
    ...
    def get_input_values(self, inputs_layout):
        return    [float(child.text) for child in self.inputs_layout2.children if isinstance(child, TextInput)]
